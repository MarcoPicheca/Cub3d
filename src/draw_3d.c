...
diff serve per capire dove prendere il colore della texture "scorrendola" verticalmente
[scostamento/differenza verticale]
dd->step e' un fattore di scala (quanto avanzare sulla texture in base ad altezza muro sullo schermo)
*/
